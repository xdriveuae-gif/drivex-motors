...
(function () {
  ...
  function waLink() {
    var msg = "Hi, I'm interested in the " + vehicle.title + ' (' + vehicle.year + ') listed for ' +
      DX.fmtPrice(vehicle.price) + '. ' + data.url + '/vehicle.html?id=' + vehicle.id;
  ...
  function mailLink() {
    ...
    var bd = 'Hello,%0D%0A%0D%0AI would like more information about the ' +
      ...
      '.%0D%0A%0D%0ALink: ' + data.url + '/vehicle.html?id=' + vehicle.id;
  ...
  function bindActions() {
    ...
    document.getElementById('shareBtn').addEventListener('click', function () {
      var url = data.url + '/vehicle.html?id=' + vehicle.id;
      if (navigator.share) {
