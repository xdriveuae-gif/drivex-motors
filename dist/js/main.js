  ...
  function vehicleCard(v) {
    ...
    return '' +
      '<article class="vehicle-card" data-reveal>' +
        '<div class="vc-media">' +
          '<a href="/vehicle.html?id=' + v.id + '" aria-label="' + escapeHtml(v.title) + '">' +
        ...
        '</div>' +
        '<div class="vc-body">' +
          '<h3 class="vc-title"><a href="/vehicle.html?id=' + v.id + '">' + escapeHtml(v.title) + '</a></h3>' +
          ...
          '</ul>' +
          '<a href="/vehicle.html?id=' + v.id + '" class="btn btn-outline btn-sm btn-block vc-link">View Details</a>' +
        '</div>' +
      '</article>';
  }
